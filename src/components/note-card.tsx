...
export function NoteCart({ note }: NoteCartProps) {
  return (
    <Dialog.Root>
      ...
      <Dialog.Portal>
        ...
        <Dialog.Content className="fixed left-1/2 top-1/2 -translate-x-1/2 -traslate-y-1/2 max-w-[640px] w-full bg-slate-700 rounded-md flex flex-col outline-none">
          Oi
        </Dialog.Content>
      </Dialog.Portal>
    </Dialog.Root>
